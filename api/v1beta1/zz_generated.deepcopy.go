...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConnectorContainer) DeepCopyInto(out *ConnectorContainer) {
	*out = *in
	if in.Ports != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConnectorContainer.
func (in *ConnectorContainer) DeepCopy() *ConnectorContainer {
	if in == nil {
		return nil
	}
	out := new(ConnectorContainer)
	in.DeepCopyInto(out)
	return out
}
